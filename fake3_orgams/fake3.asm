...
/*
 *  This file is written with basm syntax in mind.
 * It is then automatically converted to an orgams compatible asci syntax to serve as a orgams hello world
 *   - included files are completely copy pasted within the resulting file
 *   - expressions are rewritten in a orgams compatible way
 *   - new file name is EFFECT.ASM
 */
...
init_assets_with_firmware
	...
	ld bc, 0x7f00 + FAKE3_DATA_BANK : out (c), c
...
.loop
	...
	call 0xbb5a
	jr .loop
.msg db 10, "PART3 is as FAKE3 BUT written in ORGAMS !!", 0
